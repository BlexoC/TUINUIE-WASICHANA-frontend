...
const HeroSection = () => {
  ...
  return <section id="hero-section" className="relative w-full bg-white">
    ...
    /* Full-width Hero Banner with Schoolgirls Background Image matching Figma */
      ...
      <div className="relative w-full min-h-[580px] lg:min-h-[640px] flex items-center overflow-hidden bg-slate-900">
        {
  ...
  />
    ...
    /* Soft atmospheric white-to-transparent gradient on the left for maximum text contrast */
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-white/95 via-white/85 to-transparent sm:w-4/5 lg:w-3/5" />
