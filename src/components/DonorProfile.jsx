...
const DonorProfile = () => {
  ...
  return <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8">
    ...
    /* Donor Banner Header */
      ...
      <div className="bg-gradient-to-r from-purple-950 via-purple-900 to-indigo-950 text-white rounded-3xl p-6 sm:p-10 shadow-xl relative overflow-hidden">
  ...
  >
    ...
    key={badge.id}
    className={`p-5 rounded-2xl border transition-all ${badge.unlocked ? "bg-gradient-to-b from-purple-50/60 to-white border-purple-200 shadow-sm" : "bg-slate-50 border-slate-200 opacity-60"}`}
  >
