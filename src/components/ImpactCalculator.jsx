...
const ImpactCalculator = ({ embedded = false }) => {
  ...
  return <div
    className={`rounded-3xl border border-purple-100 bg-gradient-to-br from-white via-purple-50/40 to-amber-50/30 p-6 sm:p-8 shadow-xl relative overflow-hidden ${embedded ? "w-full" : "max-w-4xl mx-auto"}`}
  >
      {
  ...
  />
    ...
    className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-3.5 bg-gradient-to-r from-purple-900 to-purple-800 text-white font-bold rounded-2xl hover:from-purple-800 hover:to-purple-700 transition-all shadow-lg shadow-purple-900/25 active:scale-95"
  >
