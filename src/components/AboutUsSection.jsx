...
const AboutUsSection = () => {
  ...
  return <section id="about-us-section" className="bg-slate-50/80 py-20 relative overflow-hidden">
    ...
    /* How You Help Box */
              ...
              <div className="bg-gradient-to-br from-purple-50/80 to-purple-100/30 rounded-2xl p-5 sm:p-6 border border-purple-200/80 space-y-3">
  ...
  >
    ...
    /* Photo & Impact Metrics Column */
            ...
            <div className="lg:col-span-5 relative">
              <div className="rounded-3xl overflow-hidden shadow-xl aspect-4/3 sm:aspect-1/1 lg:aspect-4/3 relative border-4 border-white">
                <img
