...
const CrisisBanner = () => {
  ...
  return <div
    ...
    className="bg-gradient-to-r from-rose-900 via-rose-800 to-purple-950 text-white py-3.5 px-4 sm:px-6 relative shadow-md border-b border-rose-700/50"
  >
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-3 text-xs sm:text-sm">
        <div className="flex items-center gap-3 w-full md:w-auto">
          <div className="flex-shrink-0 w-8 h-8 rounded-xl bg-white/10 flex items-center justify-center text-rose-300 animate-pulse">
